...
//        System.out.println(Calculator.squareRootExtraction(169));
        ...
        System.out.println("Покупка со скидкой: " + calculatingDiscount(100, 10));

        assertThat(Calculator.calculatingDiscount(100, 10)).isEqualTo(90);

        assertThatThrownBy(() ->
                Calculator.calculatingDiscount(-10, 10)).isInstanceOf(ArithmeticException.class);
        assertThatThrownBy(() ->
                Calculator.calculatingDiscount(10, 1000)).isInstanceOf(ArithmeticException.class);
        assertThatThrownBy(() ->
                Calculator.calculatingDiscount(10, -5)).isInstanceOf(ArithmeticException.class);
